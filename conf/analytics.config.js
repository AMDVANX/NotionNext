...
module.exports = {
  ...
  ANALYTICS_51LA_ID: process.env.NEXT_PUBLIC_ANALYTICS_51LA_ID || '3M7pU1LzXlMsmSMc', // id，在51la后台获取 参阅 https://docs.tangly1024.com/article/notion-next-51-la
  ANALYTICS_51LA_CK: process.env.NEXT_PUBLIC_ANALYTICS_51LA_CK || '3M7pU1LzXlMsmSMc', // ck，在51la后台获取
  ...
  // 微软 Clarity 站点分析
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || rgwnru0awp // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合
