...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://delightful-basil-bc0.notion.site/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  // Important page_id！！！Duplicate Template from  https://tanghh.notion.site/02ab3b8678004aa69e9e415905ef32a5
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '14032d465c8c80728c06e92d941414a2',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Valhalla', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '欢迎来到英灵殿', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://Vigrid.icu', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '紐森伯格,武装JK,战术', // 网站关键词 英文逗号隔开
  ...
  // RSS订阅
  ENABLE_RSS: process.env.NEXT_PUBLIC_ENABLE_RSS || falsep, // 是否开启RSS订阅功能
